...
<html lang="en">
    ...
    <body>
            ...
            <div class="container py-md-5">
                        ...
                        <div class="card shadow mb-3">
                            ...
                            <div class="card-body">                                
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3"><label class="form-label" for="Position"><strong>Position</strong></label></div><input class="form-control" type="text" placeholder="Visiting lecturer">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3"><label class="form-label" for="Staff_ID"><strong>Staff ID</strong></label></div><input class="form-control" type="text" placeholder="STAFF043">
                                        </div>
                                        <div class="col">
                                            <div class="mb-3"><label class="form-label" for="Dep_ID"><strong>Department ID</strong></label></div><input class="form-control" type="text" placeholder="DEP043">
                                        </div>
                                    </div>
                                    <div class="mb-3"></div>
            ...
            <script src="../Profile/STAFF-form/validation.js" type="text/javascript"></script>
